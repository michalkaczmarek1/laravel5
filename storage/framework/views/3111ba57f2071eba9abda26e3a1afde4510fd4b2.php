...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"  style="font-size: 20px; padding-bottom: 10px; text-align: center;"><?php echo e(__('Rejestracja')); ?></div>
                ...
                <div class="card-body" style="margin-left: 20px;">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Adres email')); ?></label>
